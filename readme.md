...
- [ v] Fork this repo and clone a local copy to work in.

- [ v ] Read the provided `NumberTriange.java` file to understand the definition of a number triangle and what
      methods and variables we have defined to represent the structure.

- [v ] Implement the static method for loading a number triangle from a file.
